...
> 由 scripts/sync.py 自动生成（2026-08-15 15:09），请勿手改。手写内容请放 tools/docs/ 等目录。
...
- README.md — [tools/prompts/README.md](tools/prompts/README.md)

## 脚本 / 工作流

- README.md — [tools/scripts/README.md](tools/scripts/README.md)

## 配置模板

- README.md — [tools/configs/README.md](tools/configs/README.md)
...
- AGENTS.md — [tools/rules/AGENTS.md](tools/rules/AGENTS.md)
